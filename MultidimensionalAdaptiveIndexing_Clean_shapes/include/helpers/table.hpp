...
class Table{
    public:
        ...
        std::vector<std::unique_ptr<Column>> max_columns;
        ...
        static std::unique_ptr<Table> read_file_dinos(std::string path, int dataSize, int dimensions, std::unique_ptr<Table> &max_table);
        ...
        void append(float* row, int column);
