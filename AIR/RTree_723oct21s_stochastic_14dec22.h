...
#elif datacount114M
    #define DATA_COUNT 114000000
#elif datacount1M
    #define DATA_COUNT 1000000
#elif datacount2
    #define DATA_COUNT 2
#elif datacount8M
    #define DATA_COUNT 8000000
#elif datacount20M
    #define DATA_COUNT 20000000
#elif datacount40M
    #define DATA_COUNT 40000000
#elif datacount60M
...
float RTREE_QUAL::RectVolume(Rect *a_rect) {
    ...
    for (int index = 1; index < NUMDIMS; ++index) {
        ...
        if(volume < 0) {
            ...
            {
                cout << std::setprecision(15) << a_rect->m_min[ii] << " ";
            }
            cout << "\nMax\n";
            for(int ii = 0; ii < NUMDIMS; ++ii)
            {
                cout << std::setprecision(15) << a_rect->m_max[ii] << " ";
            }
            cout << "\n";
            // cout << std::setprecision(15) << "the rect min was: " << a_rect->m_min[0] << " " << a_rect->m_min[1] << " " << a_rect->m_min[2] << " " << a_rect->m_min[3] << " " << a_rect->m_min[4] << " " << a_rect->m_min[5] << " " << a_rect->m_min[6] << endl;
            // cout << std::setprecision(15) << "the rect max was: " << a_rect->m_max[0] << " " << a_rect->m_max[1] << " " << a_rect->m_max[2] << " " << a_rect->m_max[3] << " " << a_rect->m_max[4] << " " << a_rect->m_max[5] << " " << a_rect->m_max[6] << endl;
        }
